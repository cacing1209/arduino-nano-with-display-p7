...
// Pola bunyi buzzer. Dijalanin non-blocking dari buzzerTick(), jadi countdown
// dan refresh panel nggak ketahan pas buzzer bunyi.
enum class BuzzPattern : uint8_t {
  ...
  GAME_OVER,  // distop paksa: 2 nada turun
};
